...
final class GlobalDefinitions {
    ...
    static let apiKey = "ZbA7uBCXiTTI661K"

    static let sdkDomainUrl = "https://analytics.korrekted.com"
    static let sdkApiKey = "K9LbiheAmbgNIIjn"

    static let applicationTag = "EXAM_ABA"

    static let amplitudeApiKey = "b503251969f4b1d7901d2f7d1388d476"
    static let appsFlyerApiKey = "DCciCfYXjMQ8QnkdCg8qzk"

    static let appStoreUrl = "https://apps.apple.com/app/aba-exam/id1623173587"
    static let appleAppID = "1623173587"
